...
let CindyGL = function(api) {
    ...
    api.defineFunction("cgl3dRenderTranslucent", 1, (args, modifs) => {
        ...
        let renderObjects = getRenderObjects(args[0]);
        // sort triangular meshes by depth
        renderObjects.forEach((obj)=>{
            ...
            const trafo = CindyGL.sceneRenderer.transform;
            const viewNormal = [trafo[8],trafo[9],trafo[10]];
        ...
        CindyGL.sceneRenderer.renderTranslucent(renderObjects);
        return nada;
    });
